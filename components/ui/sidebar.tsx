...
>(
  (
    ...
    return (
      <div
        ref={ref}
        className="group peer hidden text-sidebar-foreground md:flex shrink-0"
        data-state={state}
      ...
      >
        <div
          className={cn(
            "sticky inset-y-0 top-0 z-10 h-svh w-[--sidebar-width] transition-[left,right,width] duration-200 ease-linear flex",
