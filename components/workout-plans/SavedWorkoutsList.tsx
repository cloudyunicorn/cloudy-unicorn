...
import { getSavedWorkoutPrograms, saveWorkoutProgram } from '@/lib/actions/user.action';
...
export const SavedWorkoutsList = ({ initialPrograms = [], onSave }: SavedWorkoutsListProps) => {
  ...
  const fetchSavedPrograms = async () => {
    setIsLoading(true);
    try {
      const result = await getSavedWorkoutPrograms();
      if (result?.programs) {
  ...
  const handleSaveProgram = async (title: string, description: string, difficulty: string) => {
    setIsLoading(true);
    try {
