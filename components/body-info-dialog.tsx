...
const bodyInfoSchema = z.object({
  ...
  goals: z
    .array(z.nativeEnum(fitnessGoalEnum))
  ...
  return (
    <Dialog open={isOpen} onOpenChange={setIsOpen}>
      <DialogTrigger asChild>
        <Button
          variant="outline"
          className="w-full justify-start items-center gap-2 px-3"
        >
          <UserCog size={20} />
            ...
            <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <FormField
                  ...
                  name="height"
                  render={({ field }) => {
                    const convertCmToFeetInches = (cm: number | null) => {
                      if (!cm) return '';
                    ...
                    return (
                      <FormItem>
                        ...
                        {field.value && (
                          <FormDescription>
                            ≈ {convertCmToFeetInches(field.value)}
                          </FormDescription>
                        )}
                        <FormMessage />
                      </FormItem>
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      ...
                      <FormDescription>Estimate if unsure.</FormDescription>
                      <FormMessage />
                    </FormItem>
                  )}
                />
                        ...
                        <SelectContent>
                          {Object.values(difficultyLevelEnum).map((level) => (
                            <SelectItem key={level} value={level}>
                              {level.charAt(0) +
                                level.slice(1).toLowerCase().replace(/_/g, ' ')}
                            </SelectItem>
                          ))}
                        </SelectContent>
                      </Select>
